...
const IndexPage = ({ isAuthenticated }: { isAuthenticated: boolean }) => {
  ...
  return (
    <div className="font-gotu">
      ...
      <ParallaxBanner style={{ aspectRatio: '21 / 10', width: '100%' }}>
        <ParallaxBannerLayer image="images/mountains.png" speed={-15} className="quality-high" />
        <ParallaxBannerLayer>
          <div className="flex flex-col items-center justify-center h-full w-full font-raleway font-thin text-center mx-3 text-ellipsis text-white">
            <h1 className="text-white text-5xl lg:text-7xl text-ellipsis">
              amanda white photography
            </h1>
            <p className="text-white font-unbounded text-lg lg:text-3xl text-ellipsis">
